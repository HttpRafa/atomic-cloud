...
/**
 * The Bytes interface represents a subscription channel that handles byte messages.
 * It extends the Closeable interface, allowing the channel to be closed when no longer needed.
 */
