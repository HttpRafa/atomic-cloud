...
/**
 * The Strings class represents a subscription channel that handles string messages.
 * It wraps a Bytes instance to process byte messages and convert them to string messages.
 * This class implements the Closeable interface, allowing the channel to be closed when no longer needed.
 */
@AllArgsConstructor
