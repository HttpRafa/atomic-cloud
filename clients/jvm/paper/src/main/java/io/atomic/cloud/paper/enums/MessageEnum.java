...
public enum MessageEnum {
    ...
    TRANSFER_USER_ALL("<aqua>☁  <color:#5D73EE>Requesting to transfer <color:#23BFFF>all users <color:#5D73EE>to new <color:#23BFFF>servers..."),
    TRANSFER_USER_AMOUNT("<aqua>☁  <color:#5D73EE>Transferring <color:#23BFFF>{} users <color:#5D73EE>to <color:#23BFFF>{}..."),
    TRANSFER_USER_FAILED("<gold>⚠ <red>Failed to transfer <color:#FA2E2E>{} users <red>to server! <gray>(<gold>{}<gray>)"),
    TRANSFER_SUCCESS("<aqua>☁ <color:#5D73EE>Successfully submitted <color:#23BFFF>{} <color:#5D73EE>transfer requests to controller."),
